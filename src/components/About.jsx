        ...
        <section id="about">
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    Hi, I'm Lakshmi Priya. </h1>
                    <h3 className="title-font text-white text-2xl" >A self-taught programmer who enjoys learning new skills and technologies.</h3>
                    <p className="mb-8 leading-relaxed">
                    I'm driven by a passion to learn and explore topics that pique my interest. 
                    I am a goal-oriented person with a preference towards backend development.</p>
